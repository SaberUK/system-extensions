...
namespace SystemExt.Demo
{
    ...
    public static class Network
    {
        ...
        private class EchoServerClient : TCPServerClient<EchoServerClient>
        {
            ...
            {
                Console.WriteLine("Client {0} ({1}) disconnected (error: {2})", this.GetHashCode(), this.EndPoint, error == null ? "none" : error.Message);
            }
            ...
            {
                Console.WriteLine("Client {0} ({1}) connected", this.GetHashCode(), this.EndPoint);
            }
